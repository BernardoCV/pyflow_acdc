"""Usage guide: Adding an electrolyser (``docs/usage_hydrogen.rst``)."""
...
assert grid.nelectrolysers == 2
assert len(grid.nodes_AC[0].connected_electrolyser) == 1
assert len(grid.nodes_DC[0].connected_electrolyser) == 1
