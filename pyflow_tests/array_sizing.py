...
for combo in combinations:
    ...
    if opt_type == 'W':
        pyf.add_RenSource_zone(grid, 'OWPP')
        pyf.add_TimeSeries(grid, Power_dist,associated='OWPP',TS_type='WPP',name='power')
        pyf.add_TimeSeries(grid, prob,associated='TEP_w',TS_type='w',name='TEP_w')


        pyf.add_RenSource(grid,'T1', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T2', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T3', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T4', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T5', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T6', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T7', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
        pyf.add_RenSource(grid,'T8', power_rating,min_gamma=gamma_limit,Qrel=0.3,zone='OWPP')
