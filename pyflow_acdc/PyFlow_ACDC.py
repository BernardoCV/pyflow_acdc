    ...
    if AC_node_data is None:
        ...
        for index, row in AC_node_data.iterrows():
            ...
            AC_nodes[var_name] = Node_AC(element_type, Voltage_0, theta_0, Power_Gained,
                                         Reactive_Gained, Power_load, Reactive_load, name=str(var_name))
    ...
    if DC_node_data is None:
        ...
        for index, row in DC_node_data.iterrows():
            ...
            DC_nodes[var_name] = Node_DC(
                node_type, Voltage_0, Power_Gained, Power_load, name=str(var_name))
...
class Node_AC:
    ...
    def __init__(self, node_type: str, Voltage_0: float, theta_0: float, Power_Gained: float, Reactive_Gained: float, Power_load: float, Reactive_load: float, name=None, used=False):
...
class Node_DC:
    ...
    def __init__(self, node_type: str, Voltage_0: float, Power_Gained: float, Power_load: float, name=None, used=False):
