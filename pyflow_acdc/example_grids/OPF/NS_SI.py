...
def NS_SI():    
    ...
    # Add Generators
    pyf.add_gen(grid, 'BE4', 'BE4', price_link=True, lf=97.27, qf=0, MWmax=1572.0, MWmin=0, MVArmax=786.0, MVArmin=-786.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'BE7', 'BE7', price_link=True, lf=97.27, qf=0, MWmax=1572.0, MWmin=0, MVArmax=786.0, MVArmin=-786.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'DE1', 'DE1', price_link=True, lf=95.67, qf=0, MWmax=4670.0, MWmin=0, MVArmax=2335.0, MVArmin=-2335.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'DE2', 'DE2', price_link=True, lf=95.67, qf=0, MWmax=4670.0, MWmin=0, MVArmax=2335.0, MVArmin=-2335.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'DE3', 'DE3', price_link=True, lf=95.67, qf=0, MWmax=4670.0, MWmin=0, MVArmax=2335.0, MVArmin=-2335.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'DE5', 'DE5', price_link=True, lf=95.67, qf=0, MWmax=4670.0, MWmin=0, MVArmax=2335.0, MVArmin=-2335.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'DK4', 'DK4', price_link=True, lf=81.26, qf=0, MWmax=1744.0000000000002, MWmin=0, MVArmax=872.0000000000001, MVArmin=-872.0000000000001, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'DK7', 'DK7', price_link=True, lf=81.26, qf=0, MWmax=2330.0, MWmin=0, MVArmax=1165.0, MVArmin=-1165.0, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'GB1', 'GB1', price_link=True, lf=108.23, qf=0, MWmax=4670.0, MWmin=0, MVArmax=894.5, MVArmin=-894.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'GB21', 'GB21', price_link=True, lf=108.23, qf=0, MWmax=4670.0, MWmin=0, MVArmax=894.5, MVArmin=-894.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'GB23', 'GB23', price_link=True, lf=108.23, qf=0, MWmax=4670.0, MWmin=0, MVArmax=894.5, MVArmin=-894.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'GB25', 'GB25', price_link=True, lf=108.23, qf=0, MWmax=4670.0, MWmin=0, MVArmax=894.5, MVArmin=-894.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'NL6', 'NL6', price_link=True, lf=95.82, qf=0, MWmax=3013.0, MWmin=0, MVArmax=1506.5, MVArmin=-1506.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'NL10', 'NL10', price_link=True, lf=95.82, qf=0, MWmax=3013.0, MWmin=0, MVArmax=1506.5, MVArmin=-1506.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'NO8', 'NO8', price_link=True, lf=79.44, qf=0, MWmax=2173.0, MWmin=0, MVArmax=1086.5, MVArmin=-1086.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'NO9', 'NO9', price_link=True, lf=79.44, qf=0, MWmax=2173.0, MWmin=0, MVArmax=1086.5, MVArmin=-1086.5, PsetMW=0, QsetMVA=0)
    pyf.add_gen(grid, 'GB20', 'GB20', price_link=True, lf=108.23, qf=0, MWmax=545.0, MWmin=490.5, MVArmax=545.0, MVArmin=-545.0, PsetMW=0.0, QsetMVA=0.0)
