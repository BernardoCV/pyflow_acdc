...
def pglib_opf_hvdc_case67():    
    ...
    # Add Generators
    pyf.add_gen(grid, '1.0', '1', lf=10, qf=0, MWmax=1000.0, MWmin=0.0, MVArmax=1000.0, MVArmin=-500.0, PsetMW=700.0, QsetMVA=23.0)
    pyf.add_gen(grid, '2.0', '2', lf=10, qf=0, MWmax=1500.0, MWmin=0.0, MVArmax=0.0, MVArmin=0.0, PsetMW=1500.0, QsetMVA=100.0)
    pyf.add_gen(grid, '4.0', '3', lf=10, qf=0, MWmax=560.0, MWmin=0.0, MVArmax=350.0, MVArmin=-350.0, PsetMW=523.0, QsetMVA=140.0)
    pyf.add_gen(grid, '5.0', '4', lf=10, qf=0, MWmax=1200.0, MWmin=0.0, MVArmax=0.0, MVArmin=0.0, PsetMW=1200.0, QsetMVA=100.0)
    pyf.add_gen(grid, '10.0', '5', lf=10, qf=0, MWmax=560.0, MWmin=0.0, MVArmax=350.0, MVArmin=-350.0, PsetMW=436.00000000000006, QsetMVA=105.0)
    pyf.add_gen(grid, '13.0', '6', lf=10, qf=0, MWmax=630.0, MWmin=0.0, MVArmax=300.0, MVArmin=-300.0, PsetMW=541.0, QsetMVA=117.0)
    pyf.add_gen(grid, '18.0', '7', lf=10, qf=0, MWmax=720.0, MWmin=0.0, MVArmax=400.0, MVArmin=-400.0, PsetMW=681.0, QsetMVA=-35.0)
    pyf.add_gen(grid, '25.0', '8', lf=10, qf=0, MWmax=560.0, MWmin=0.0, MVArmax=250.0, MVArmin=-250.0, PsetMW=469.00000000000006, QsetMVA=59.0)
    pyf.add_gen(grid, '29.0', '9', lf=10, qf=0, MWmax=630.0, MWmin=0.0, MVArmax=350.0, MVArmin=-350.0, PsetMW=500.0, QsetMVA=101.0)
    pyf.add_gen(grid, '33.0', '10', lf=10, qf=0, MWmax=850.0, MWmin=0.0, MVArmax=500.0, MVArmin=-500.0, PsetMW=496.0, QsetMVA=306.0)
    pyf.add_gen(grid, '36.0', '11', lf=10, qf=0, MWmax=720.0, MWmin=0.0, MVArmax=400.0, MVArmin=-400.0, PsetMW=512.0, QsetMVA=249.00000000000003)
    pyf.add_gen(grid, '41.0', '12', lf=10, qf=0, MWmax=850.0, MWmin=0.0, MVArmax=450.0, MVArmin=-450.0, PsetMW=350.0, QsetMVA=238.0)
    pyf.add_gen(grid, '43.0', '13', lf=10, qf=0, MWmax=720.0, MWmin=0.0, MVArmax=500.0, MVArmin=-250.0, PsetMW=574.0, QsetMVA=223.0)
    pyf.add_gen(grid, '50.0', '14', lf=10, qf=0, MWmax=720.0, MWmin=0.0, MVArmax=400.0, MVArmin=-400.0, PsetMW=581.0, QsetMVA=150.0)
    pyf.add_gen(grid, '56.0', '15', lf=10, qf=0, MWmax=560.0, MWmin=0.0, MVArmax=250.0, MVArmin=-250.0, PsetMW=496.0, QsetMVA=56.00000000000001)
    pyf.add_gen(grid, '59.0', '16', lf=10, qf=0, MWmax=720.0, MWmin=0.0, MVArmax=350.0, MVArmin=-350.0, PsetMW=430.99999999999994, QsetMVA=206.0)
    pyf.add_gen(grid, '63.0', '17', lf=10, qf=0, MWmax=520.0, MWmin=0.0, MVArmax=250.0, MVArmin=-300.0, PsetMW=488.0, QsetMVA=152.0)
    pyf.add_gen(grid, '64.0', '18', lf=10, qf=0, MWmax=560.0, MWmin=0.0, MVArmax=250.0, MVArmin=-400.0, PsetMW=300.0, QsetMVA=61.0)
    pyf.add_gen(grid, '66.0', '19', lf=10, qf=0, MWmax=630.0, MWmin=0.0, MVArmax=300.0, MVArmin=-400.0, PsetMW=537.0, QsetMVA=143.0)
    pyf.add_gen(grid, '67.0', '20', lf=10, qf=0, MWmax=800.0, MWmin=0.0, MVArmax=0.0, MVArmin=0.0, PsetMW=800.0, QsetMVA=0.0)
