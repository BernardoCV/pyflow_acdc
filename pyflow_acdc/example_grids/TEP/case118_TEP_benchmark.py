...
def case118_TEP_benchmark(exp_220=None,exp_380=None,slack=1,curtailment_allowed=1,load_factor=1,export_capacity=15000,Gen_Pmin=True,DC=False,DC_exp=False):
    ...
    pyf.add_extgrid(grid,'10','Ext_10',lf=0,MVAmax=export_capacity/3) 
    pyf.add_extgrid(grid, '119','Ext_119',lf=0,MVAmax=export_capacity/3)  
    pyf.add_extgrid(grid, '120','Ext_120',lf=0,MVAmax=export_capacity/3) 
